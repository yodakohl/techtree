...
| --- | --- |
| Technologies | 1,661 |
| Source-checked nodes | 553 / 1,661 (33.3%) |
| Nodes with node-level sources | 588 / 1,661 (35.4%) |
| Dependency edges with edge-level sources | 1,623 / 5,653 (28.7%) |
| Era-default placeholder dates | 679 / 1,661 (40.9%) |
