...
| --- | --- |
| Technologies | 1,662 |
| Source-checked nodes | 545 / 1,662 (32.8%) |
| Nodes with node-level sources | 580 / 1,662 (34.9%) |
| Dependency edges with edge-level sources | 1,604 / 5,667 (28.3%) |
| Era-default placeholder dates | 688 / 1,662 (41.4%) |
