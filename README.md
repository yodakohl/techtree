...
| --- | --- |
| Technologies | 1,661 |
| Source-checked nodes | 554 / 1,661 (33.4%) |
| Nodes with node-level sources | 589 / 1,661 (35.5%) |
| Dependency edges with edge-level sources | 1,625 / 5,653 (28.7%) |
| Era-default placeholder dates | 678 / 1,661 (40.8%) |
