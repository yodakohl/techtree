...
| --- | --- |
| Technologies | 1,664 |
| Source-checked nodes | 519 / 1,664 (31.2%) |
| Nodes with node-level sources | 561 / 1,664 (33.7%) |
| Dependency edges with edge-level sources | 1,537 / 5,706 (26.9%) |
| Era-default dates | 723 / 1,664 (43.4%) |
