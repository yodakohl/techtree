...
| --- | --- |
| Technologies | 1,660 |
| Source-checked nodes | 603 / 1,660 (36.3%) |
| Nodes with node-level sources | 634 / 1,660 (38.2%) |
| Dependency edges with edge-level sources | 1,804 / 5,590 (32.3%) |
| Era-default placeholder dates | 569 / 1,660 (34.3%) |
