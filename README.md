...
| --- | --- |
| Technologies | 1,662 |
| Source-checked nodes | 552 / 1,662 (33.2%) |
| Nodes with node-level sources | 587 / 1,662 (35.3%) |
| Dependency edges with edge-level sources | 1,620 / 5,658 (28.6%) |
| Era-default placeholder dates | 681 / 1,662 (41.0%) |
