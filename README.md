...
| --- | --- |
| Technologies | 1,664 |
| Source-checked nodes | 528 / 1,664 (31.7%) |
| Nodes with node-level sources | 568 / 1,664 (34.1%) |
| Dependency edges with edge-level sources | 1,569 / 5,686 (27.6%) |
| Era-default placeholder dates | 704 / 1,664 (42.3%) |
