...
| --- | --- |
| Technologies | 1,664 |
| Source-checked nodes | 538 / 1,664 (32.3%) |
| Nodes with node-level sources | 575 / 1,664 (34.6%) |
| Dependency edges with edge-level sources | 1,587 / 5,683 (27.9%) |
| Era-default placeholder dates | 694 / 1,664 (41.7%) |
