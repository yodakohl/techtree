...
| --- | --- |
| Technologies | 1,664 |
| Source-checked nodes | 533 / 1,664 (32.0%) |
| Nodes with node-level sources | 573 / 1,664 (34.4%) |
| Dependency edges with edge-level sources | 1,579 / 5,686 (27.8%) |
| Era-default placeholder dates | 698 / 1,664 (41.9%) |
