...
| --- | --- |
| Technologies | 1,660 |
| Source-checked nodes | 608 / 1,660 (36.6%) |
| Nodes with node-level sources | 639 / 1,660 (38.5%) |
| Dependency edges with edge-level sources | 1,821 / 5,588 (32.6%) |
| Era-default placeholder dates | 567 / 1,660 (34.2%) |
