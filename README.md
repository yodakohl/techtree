...
| --- | --- |
| Technologies | 1,659 |
| Source-checked nodes | 1,262 / 1,659 (76.1%) |
| Source-checked nodes with non-placeholder dates | 1,109 / 1,262 (87.9%) |
| Source-checked nodes with placeholder dates | 153 / 1,262 (12.1%) |
| Source-checked nodes with primary/review/textbook/official sources | 1,091 / 1,262 (86.5%) |
| Source-checked nodes using only weak/generic sources | 0 / 1,262 (0.0%) |
| Nodes with node-level sources | 1,551 / 1,659 (93.5%) |
| Dependency edges with edge-level sources | 4,015 / 5,461 (73.5%) |
| Era-default placeholder dates | 435 / 1,659 (26.2%) |
