...
| Source-checked nodes | 1,371 / 1,420 (96.5%) |
| Source-checked nodes with non-placeholder dates | 1,371 / 1,371 (100.0%) |
| Source-checked nodes with placeholder dates | 0 / 1,371 (0.0%) |
| Source-checked nodes with primary/review/textbook/official sources | 1,215 / 1,371 (88.6%) |
| Source-checked nodes using only weak/generic sources | 0 / 1,371 (0.0%) |
| Nodes with node-level sources | 1,419 / 1,420 (99.9%) |
| Dependency edges with edge-level sources | 3,710 / 4,355 (85.2%) |
| Era-default placeholder dates | 15 / 1,420 (1.1%) |
