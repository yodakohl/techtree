...
| --- | --- |
| Technologies | 1,659 |
| Source-checked nodes | 1,246 / 1,659 (75.1%) |
| Source-checked nodes with non-placeholder dates | 1,111 / 1,246 (89.2%) |
| Source-checked nodes with placeholder dates | 135 / 1,246 (10.8%) |
| Source-checked nodes with primary/review/textbook/official sources | 1,074 / 1,246 (86.2%) |
| Source-checked nodes using only weak/generic sources | 0 / 1,246 (0.0%) |
