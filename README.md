...
| --- | --- |
| Technologies | 1,660 |
| Source-checked nodes | 587 / 1,660 (35.4%) |
| Nodes with node-level sources | 612 / 1,660 (36.9%) |
| Dependency edges with edge-level sources | 1,639 / 5,639 (29.1%) |
| Era-default placeholder dates | 602 / 1,660 (36.3%) |
