...
| --- | --- |
| Technologies | 1,660 |
| Source-checked nodes | 607 / 1,660 (36.6%) |
| Nodes with node-level sources | 638 / 1,660 (38.4%) |
| Dependency edges with edge-level sources | 1,816 / 5,590 (32.5%) |
| Era-default placeholder dates | 568 / 1,660 (34.2%) |
