...
| --- | --- |
| Technologies | 1,660 |
| Source-checked nodes | 561 / 1,660 (33.8%) |
| Nodes with node-level sources | 596 / 1,660 (35.9%) |
| Dependency edges with edge-level sources | 1,634 / 5,646 (28.9%) |
| Era-default placeholder dates | 673 / 1,660 (40.5%) |
