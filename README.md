...
| --- | --- |
| Technologies | 1,664 |
| Source-checked nodes | 496 / 1,664 (29.8%) |
| Nodes with node-level sources | 539 / 1,664 (32.4%) |
| Dependency edges with edge-level sources | 1,505 / 5,725 (26.3%) |
| Era-default dates | 760 / 1,664 (45.7%) |
