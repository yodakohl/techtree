...
| --- | --- |
| Technologies | 1,664 |
| Source-checked nodes | 524 / 1,664 (31.5%) |
| Nodes with node-level sources | 566 / 1,664 (34.0%) |
| Dependency edges with edge-level sources | 1,541 / 5,693 (27.1%) |
| Era-default dates | 721 / 1,664 (43.3%) |
