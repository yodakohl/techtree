...
| --- | --- |
| Technologies | 1,659 |
| Source-checked nodes | 1,477 / 1,659 (89.0%) |
| Source-checked nodes with non-placeholder dates | 1,134 / 1,477 (76.8%) |
| Source-checked nodes with placeholder dates | 343 / 1,477 (23.2%) |
| Source-checked nodes with primary/review/textbook/official sources | 1,109 / 1,477 (75.1%) |
| Source-checked nodes using only weak/generic sources | 0 / 1,477 (0.0%) |
