...
- Current validated size after the latest quality/demo pass: 1,660 curated technologies
...
- Eighteenth curated vertical, with source-checked core chronology fixes: `Civil Engineering & Built Environment`
