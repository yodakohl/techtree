...
const branchRules = [
    ...
    ['Materials & Manufacturing', ['stone_tool', 'tool', 'metal', 'bronze', 'iron', 'steel', 'alloy', 'glass', 'ceramic', 'pottery', 'textile', 'weaving', 'manufactur', 'factory', 'assembly', '3d_print', 'materials', 'polymer', 'plastic', 'composite', 'nanotechnology', 'casting', 'molding']],
    ...
    ['Computing & AI', ['abacus', 'algorithm', 'computer', 'software', 'database', 'data_', 'cloud', 'virtualization', 'internet_protocol', 'microprocessor', 'semiconductor', 'transistor', 'integrated_circuit', 'ai', 'artificial_intelligence', 'machine_learning', 'deep_learning', 'language_model', 'neural', 'robotic_process', 'quantum_computing', 'vector_database']],
    ['Communication & Media', ['writing', 'paper', 'printing', 'book', 'library', 'postal', 'telegraph', 'telephone', 'radio', 'television', 'media', 'cinema', 'photography', 'web', 'internet', 'hypertext', 'social_media', 'communication', 'storytelling']],
    ...
    ['Finance & Commerce', ['barter', 'currency', 'coin', 'bank', 'finance', 'commerce', 'trade', 'merchant', 'credit', 'insurance', 'stock', 'capital', 'corporation', 'bookkeeping', 'accounting', 'market', 'retail', 'e-commerce']],
    ['Infrastructure & Cities', ['shelter', 'construction', 'masonry', 'architecture', 'concrete', 'urban', 'city', 'aqueduct', 'sewer', 'water_', 'well', 'cistern', 'building', 'bridge', 'skyscraper', 'housing', 'public_works', 'municipal']],
    ...
    ['Arts & Culture', ['art', 'music', 'theater', 'literature', 'myth', 'ritual', 'religion', 'philosophy', 'sculpture', 'painting', 'mosaic', 'heraldry', 'chivalry', 'storytelling']]
];
